...
let projects = [
  {
    image: 'textures/possiblecode-project.png',
    url: 'https://www.possiblecode.tech/',
  },
  {
    image: 'textures/first-3d-project.png',
    url: 'https://syedmohsin.vercel.app/',
  },
  {
    image: 'textures/liyaqat-project.png',
    url: 'https://wholesale.com.np/',
  },
  {
    image: 'textures/afshan-project.png',
    url: 'https://afshankhan.vercel.app/',
  },
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('Syed MOhsin', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    const subTitleGeo = new TextGeometry(
      'Web Designer / Developer / Robotics Engineer',
      {
        font: font,
        size: 0.018,
        height: 0,
